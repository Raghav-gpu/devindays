...
function DeviceMockupHero({ caseStudy }: { caseStudy: CaseStudy }) {
  const mockupImage = (
    <Image
      ...
      sizes="(max-width: 1024px) 78vw, (max-width: 1200px) 30vw, (max-width: 1400px) 32vw, 360px"
      priority={caseStudy.id === "focusflow"}
    />
  );
  ...
  return (
    <div className="relative flex min-h-[320px] w-full items-center justify-center overflow-hidden md:min-h-[380px] lg:min-h-0 lg:h-full">
      ...
      <div
        data-case-mockup
        className="relative z-10 flex w-full max-w-full items-center justify-center px-2 will-change-transform lg:px-4 min-[1200px]:px-5 min-[1400px]:px-6"
      >
    ...
    >
      ...
      >
        <div className="relative overflow-hidden bg-[#FAFAFA] p-[clamp(16px,2.5vw,28px)] lg:p-6 min-[1200px]:p-7 min-[1400px]:p-8">
          <DeviceMockupHero caseStudy={caseStudy} />
        </div>
        ...
        <div className="flex min-h-0 min-w-0 flex-col justify-center overflow-y-auto p-[clamp(20px,3vw,36px)] lg:min-w-[420px] lg:p-6 min-[1200px]:p-7 min-[1400px]:p-8">
          ...
          <div>
            ...
            <p className="mb-4 max-w-[65ch] text-gray-600 font-light text-[clamp(1rem,1.2vw,1.125rem)] leading-relaxed lg:mb-4">
              {caseStudy.tagline}
            </p>
            <p className="mb-4 max-w-[65ch] font-normal text-gray-900 text-[clamp(1.0625rem,1.4vw,1.25rem)] lg:mb-4">
              {caseStudy.headline}
            </p>
          ...
          <div className="mt-6 grid grid-cols-1 gap-2 border-b border-gray-200 pb-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-2.5">
            {caseStudy.metrics.map((metric) => (
              <div
                ...
                className="rounded-xl bg-gray-50 border border-gray-100 px-2.5 py-2.5 text-center lg:px-3 lg:py-2.5"
              >
