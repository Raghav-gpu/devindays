              ...
              <CardContent>
                <div className="flex flex-col gap-6 justify-start">
                  ...
                  <Button variant="outline" className="gap-2 font-light text-gray-900 border-gray-300 hover:bg-gray-50 w-full" asChild>
                    <Link href="https://wa.link/lw7sw2" target="_blank" rel="noopener noreferrer" aria-label="Open WhatsApp to build your MVP">
              ...
              <CardContent>
                <div className="flex flex-col gap-6 justify-start">
                  ...
                  <Button className="gap-2 font-light bg-gray-900 hover:bg-gray-800 text-white w-full" asChild>
                    <Link href="https://wa.link/lw7sw2" target="_blank" rel="noopener noreferrer" aria-label="Open WhatsApp to get a project quote">
            ...
            <Card className="w-full rounded-md border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-xl bg-white shadow-md">
              ...
              <CardContent>
                <div className="flex flex-col gap-6 justify-start">
                  ...
                  <Button variant="outline" className="gap-2 font-light text-gray-900 border-gray-300 hover:bg-gray-50 w-full" asChild>
                    <Link href="https://wa.link/lw7sw2" target="_blank" rel="noopener noreferrer" aria-label="Open WhatsApp to discuss your requirements">
